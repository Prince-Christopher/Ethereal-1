...
public class HealthCourseActivity2 extends AppCompatActivity {
    ...
    TabItem tabDay6;
    ViewPager viewPager;
    ViewPagerHealth2Adapter viewPagerAdapter;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_health_course2);
        ...
        viewPagerAdapter = new ViewPagerHealth2Adapter(getSupportFragmentManager(), tabLayout.getTabCount());
